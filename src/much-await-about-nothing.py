...
# %% [markdown]
# The rules of how `await` behaves as a function of the argument following the keyword are summarized below.
# Futures, which are introduced in a subsequent section, are included in the table.
#
